...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(){
        ...
        add(t1);
         l12.setBounds(500,100,490,30);
        add(l12);
        
        t2.setBounds(570,100,40,30);
         add(t2);
        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    Conn c1 = new Conn();
                    String q1 = "insert into signup3 values('"+a+"','"+first8+"','"+c+"','"+e+"','"+b+"')";  
                    String q2 = "insert into login values('"+first8+"','"+e+"')";
                    String q3 ="commit";
